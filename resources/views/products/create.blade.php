...
<div id="wrap">
  ...
  <form action="{{ route('products.store2') }}" method="POST" enctype="multipart/form-data">
    @csrf
  ...
  <div class="form-raw">
      ...
      <div class="form-txtfld txtfld50"><input type="text" placeholder="desciption" name="description_"></div>
 ...
 <!--  <div class="form-raw">
  ...
  <div class="form-raw" style="width:100%;">
    ...
    <div class="form-txtfld" style="width:780px;">
      <textarea style="width:100%; height:500px;" name="features"  id="editor"> </textarea>
    </div>
  </div>
  <div class="clear"></div>
...
<div id="wrap2">
   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="admintable">
    ...
    <tr>
      ...
      <td align="left" valign="top"><a href="{{route('products.edit',$d->id)}}">Edit</a></td>
      <td align="center" valign="top"><a href="{{route('products.delete',$d->id)}}"><img src="{{asset('images/icon-bin.jpg')}}" alt="" width="25" height="25" border="0" align="absmiddle" /></a></td>
    </tr>
    @endforeach
  </table>
  <div class="clear">&nbsp;</div>
