...
<header>
  ...
  <div class="col-md-12">
    ...
    @endif
  <form method="POST" action="{{route('sub_categories.store1')}}">
    @csrf
<div id="wrap">
...
<div class="form-raw">
    ...
    <div class="form-raw">
      ...
      <div class="form-txtfld" style="width:290px;">
        <button value="submit">Submit</button>      </div>
    </div>
  </div>
</form>
  <div class="clear">&nbsp;</div>
...
<div id="wrap3">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="admintable">
    ...
    <tr>
      ...
      <td align="left" valign="top"><a href="{{route('sub_categories.edit',$d->id)}}">Edit</a></td>
      <td align="center" valign="top"><a href="{{route('sub_categories.delete',$d->id)}}"><img src="images/icon-bin.jpg" alt="" width="25" height="25" border="0" align="absmiddle" /></a></td>
    </tr>
    @endforeach
  </table>
  <div class="clear">&nbsp;</div>
